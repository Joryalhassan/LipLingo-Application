  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        body: Stack(children: [
          Positioned(
              bottom: 0, child: _buildBottom()), // to make it int hte bottom
        ]),
      ),
    );
  }
...
//form
  Widget _buildForm() {
    return SingleChildScrollView(
      // Ensures the form is scrollable on smaller devices
      child: Padding(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding:
                    const EdgeInsets.only(top: 0.2, bottom: 0.0, right: 50),
                child: Text(
                  "Register",
      ...
      child: ElevatedButton(
        onPressed: () async {
          ...
          if (_formKey.currentState!.validate()) {
            ...
            bool isEmailUnique =
                await _checkEmailUniqueness(_emailTextController.text);
            bool isUsernameUnique =
                await _checkUsernameUniqueness(_usernamecontroller.text);
            ...
            if (!isEmailUnique || !isUsernameUnique) {
              ...
              try {
                ...
                showDialog(
                  context: context,
                  barrierDismissible:
                      false, // prevent dialog to close by tapping outside of it
