...
// import 'lesson_manager.dart'; // Import the LessonManager class

// class VideoPage5 extends StatefulWidget {
//   final int lessonIndex;

//   const VideoPage5({Key? key, required this.lessonIndex}) : super(key: key);
...
//     return Scaffold(
//       appBar: topBar(context, "Lesson ${widget.lessonIndex}"),
//       body: GestureDetector(
//         onTap: () {
//           LessonManager.markLessonComplete();
//         },
//         child: Stack(
...
//               children: [
//                 Text(
//                   "Lesson ${widget.lessonIndex}: Title of Lesson",
//                   style: TextStyle(
//                     fontSize: 24,
...
//                       height: 60.0,
//                       child: CircularProgressIndicator(
//                         value: LessonManager.getProgress(),
//                         strokeWidth: 9.0,
//                         color: Colors.blue,
//                       ),
//                     ),
...
//                       left: 13.0,
//                       child: Text(
//                         "${LessonManager.completedLessons}/${LessonManager.totalLessons}",
//                         style: TextStyle(
//                           color: Colors.black,
//                           fontSize: 23.0,
//                           fontWeight: FontWeight.bold,
