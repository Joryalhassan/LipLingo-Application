          ...
          children: <Widget>[
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                padding: EdgeInsets.symmetric(vertical: 20), // Adjust padding to match design
                elevation: 4, // Add shadow
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(8), // Match button corner radius to design
                ),
              ),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  ...
                  Text(
                    'Lessons',
                    textAlign: TextAlign.center,
                    style: TextStyle(fontSize: 20), // Adjust font size to match design
                  ),
                ],
              ),
            ),
